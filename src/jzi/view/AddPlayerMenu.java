 ...
 * @author Buddy Jonte
 */
public class AddPlayerMenu extends JPanel implements Menu, ActionListener {
    /**
     *  UID serialization.
     */
     ...
     * Add player menu.
     */
    public AddPlayerMenu(IWindow window, IGame game) {
        this.window = window;
        createLabels();
        setColor();
        ...
        settingsPanel.add(addPlayer, "wrap");
