...
public class Table extends JTable {
    ...
    public final void changeLanguage() {
        ...
        Iterator<String> words = Language.getCurrentLanguageWords(4).iterator();
        TableColumn tc = tcm.getColumn(0);
        tc.setHeaderValue(words.next());
        TableColumn tc2 = tcm.getColumn(1);
        tc2.setHeaderValue(words.next());
        if (game.isHardcore()) {
            TableColumn tc3 = tcm.getColumn(5);
            tc3.setHeaderValue(words.next());
